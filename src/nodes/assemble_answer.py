...
def _build_prompt(sub_question_text: str, supporting_chunks: list[RetrievedChunk]) -> list[dict]:
    ...
    system = (
        ...
        "2. Write a brief, direct answer a floor supervisor can act on. Cite the section.\n"
        ...
        "5. If the chunks don't fully answer the question, state what they support and stop. "
